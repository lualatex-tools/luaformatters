...
which at this point is only available from its development repository. \package{luaoptions} has been developed for and part of Jacques Peron's \package{lyluatex} package%
...
%\setluaoption{formattersopts}{default-color}{green}
