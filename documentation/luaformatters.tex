...
\addLuaFormatters{examples/format}
\addLuaFormatters{examples/local-formatters.lua}
...
With \luaformatters\ a “formatter” can be declared and/or programmed completely
in Lua -- as a simple string template or an arbitrarily complex Lua function --
...
available, which is referred to as the \term{Formatters Library}.%
...
\NOTE{TO BE DONE:} The option declaration has to be fully documented, but
presumably not here but in \package{lyluatextools}, once it has been finally
