...
% Set up the Formatters object, passing a variable name prefix
...
\url{https://github.com/jperon/lyluatex}.  When \luaformatters\ will be
...
\cmd{luaformattersSetOption\{key\}\{value\}} can be used to change the value of
