...
\luavar{options} table contains the field \luavar{options.\_original} that can
be used instead of the regular lookup keys.  If no optional argument has been
given this field will contain an empty string.  See \vref{sec:examples:closures}
for an example.
