...
current \term{Client}.  See \vref{sec:advanced:reuse:local-formatters} for
details.
...
Any functions or fields stored in the client's \luavar{TemplatesTable} object
...
more extensive work as functions in the \luavar{TemplatesTable}.%
\footnote{\NOTE{TODO:} Think of/provide a useful and telling example.}
